...
export default function WithdrawalReport() {
  ...
  useEffect(() => {
    async function fetchPettycashData() {
      try {
        ...
        const withdrawalOnly = data.filter(item => item.Txn_type === "Withdrawal");
        setWithdrawalInfo(withdrawalOnly);
      } catch (error) {
  ...
  }, [withdrawalInfo, transactionTypeFilter, dateFilter, sortOrder]);
    ...
    <div className="w-full space-y-4">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        ...
        <div className="mt-4 text-sm text-gray-600">
          ...
          <span className="font-semibold">{withdrawalInfo.length}</span> withdrawals
        </div>
      </div>
