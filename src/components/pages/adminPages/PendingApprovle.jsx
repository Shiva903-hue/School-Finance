...
export default function PendingApproval() {
  ...
  // Memoize data length to avoid recalculation
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Filter only pending vouchers on client side if needed
      // const pendingVouchers = data.filter(v => v.v_status !== "APPROVE" && v.v_status !== "REJECTED");
